...
// Заполняет базу данных случайными данными о песещениях
...
Процедура СформироватьПосещенияПосетителя(Посетитель, ДатаПосещения, СписокАттракционов, ГСЧ = Неопределено)
	...
	//Проверяем для каждого посещения есть ли билет, если билете нет - покупаем доступный для нужного аттракциона
